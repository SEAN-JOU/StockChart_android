...
package com.example.stockchart.sample2
...
import com.example.stockchart.Util
...
import com.example.stockchart.childchart.kdjchart.KdjChartConfig
import com.example.stockchart.childchart.kdjchart.KdjChartFactory
import com.example.stockchart.childchart.macdchart.MacdChartConfig
import com.example.stockchart.childchart.macdchart.MacdChartFactory
import com.example.stockchart.childchart.rskchart.RsiChartConfig
import com.example.stockchart.childchart.rskchart.RsiChartFactory
...
import com.example.stockchart.childchart.volumechart.VolumeChartConfig
import com.example.stockchart.childchart.volumechart.VolumeChartFactory
import com.example.stockchart.entities.FLAG_EMPTY
import com.example.stockchart.entities.Highlight
import com.example.stockchart.entities.IKEntity
import com.example.stockchart.entities.containFlag
import com.example.stockchart.index.Index
import com.example.stockchart.listener.OnHighlightListener
import com.example.stockchart.listener.OnLoadMoreListener
import com.example.stockchart.sample2.custom.CustomChartConfig
import com.example.stockchart.sample2.custom.CustomChartFactory
import com.example.stockchart.stockchart.StockChart
import com.example.stockchart.util.DimensionUtil
import com.example.stockchart.util.NumberFormatUtil
...
class Sample2Activity : AppCompatActivity() {
    ...
    private fun initKChart() {
        ...
        tv_highlight_info = findViewById(R.id.tv_highlight_info)
